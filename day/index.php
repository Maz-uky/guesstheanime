...
$result = $webspace->query($sql = "SELECT * FROM guesstheanime WHERE guess_number = '".$game_id."'");
$row = $result->fetch_assoc();
$correctName = $row['anime_name'];
$correctEnglishName = "No english name";
$correctEnglishName = $row['anime_name_eng'];

;?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>GuessTheAnime | Game <?php echo $game_id;?> - Challenge your friends</title>
    ...
    <body>
        ...
        <main>
            <span class="counter"><i>Anime #<span id="counter"><?php echo $game_id;?></span></i></span>
            <p class="count_new">NEW ANIME IN</p>
            <span id="countdown">23:59:59</span>
            <img id="img_01" src="https://www.guesstheanime.net/picture/<?php echo $game_id;?>/01_small.webp" alt="Picture 1" class="image" width="512" height="288">
            <img id="img_02" src="https://www.guesstheanime.net/picture/<?php echo $game_id;?>/02_small.webp" alt="Picture 2" class="hidden image" width="512" height="288">
            <img id="img_03" src="https://www.guesstheanime.net/picture/<?php echo $game_id;?>/03_small.webp" alt="Picture 3" class="hidden image" width="512" height="288">
            <img id="img_04" src="https://www.guesstheanime.net/picture/<?php echo $game_id;?>/04_small.webp" alt="Picture 4" class="hidden image" width="512" height="288">
            <img id="img_05" src="https://www.guesstheanime.net/picture/<?php echo $game_id;?>/05_small.webp" alt="Picture 5" class="hidden image" width="512" height="288">
            <img id="img_06" src="https://www.guesstheanime.net/picture/<?php echo $game_id;?>/06_small.webp" alt="Picture 6" class="hidden image" width="512" height="288">
            ...
            <div class="image_numer">
                ...
                <span class="skip active" id="skip" style="background: #930000; padding: 5px 15px; border-radius: 5px; margin: 10px 5px;" onclick="enableNextNumber()">Skip?</span>
            </div>
            ...
            <div id="GameEnd">
                ...
                <span class="stream">Watch <span id="pay_name"></span> on the following streaming services.</span>
                <ul class="stream-ul">
                    <li>
        ...
        <script>
            ...
            if(game_id > game_max){window.location.href = "https://www.guesstheanime.net/home/";}
            ...
            if (xhr.status === 200) {
                ...
                localStorage.setItem("tipp_3" + game_id, tipp_3);
